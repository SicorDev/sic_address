...
### Minor
- Fixed icons for backend modules

## [6.0.0] - 2025-11-06

### Major
- First official release for TYPO3 13 and PHP 8.3
- Beta state for a while, please report issues.
...
### Fixed
- FALService fixed as suggested by Franz Holzinger.
